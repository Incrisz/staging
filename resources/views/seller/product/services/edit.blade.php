...
<form class="" action="{{route('seller.products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-lg-3 col-from-label">{{translate('service Name')}}</label>
                        <div class="col-lg-8">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Service Location/School')}}</h5>
        </div>
        <div class="card-body">
            <div class="form-group row" style="display:none;">
                <div class="col-lg-3">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{translate('Service price ')}}</h5>
        </div>
        <div class="card-body">
            <div class="form-group row">
                <label class="col-lg-3 col-from-label">{{translate('Service price')}}</label>
                <div class="col-lg-6">
