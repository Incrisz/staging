...
<section class="py-3 text-light footer-widget border-bottom" style="border-color: #f15a24 !important; background-color: #041a11 !important;">
    <div class="container">
        <!-- footer logo -->
        <div class="mt-3 mb-4">
...
@endphp
<section class="py-lg-3 text-light footer-widget" style="background-color: #041a11 !important;">
    ...
    <div class="container">
        <div class="row align-items-center py-3">
            ...
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="text-center text-lg-left fs-14" current-verison="">
...
<!-- Mobile bottom nav -->
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2" style="background-color: #1b4332 !important;">
