...
<span class="absolute-top-left   fs-11 fw-700 text-white w-55px text-center" style="background-color: red; @if(discount_in_percentage($product) > 0) left:45px; @endif">{{ $product->external_link }}</span>
@endif
